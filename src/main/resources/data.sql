...
(provider_id, direction, country, operator, flow_type, provider_channel, enabled, live_enabled, sandbox_enabled, priority, cost, avg_latency, failure_rate, updated_at)
SELECT pp.id, seed.direction, seed.country, seed.operator, seed.flow_type, seed.provider_channel,
       seed.enabled, seed.live_enabled, seed.sandbox_enabled, seed.priority, seed.cost, seed.avg_latency, seed.failure_rate, CURRENT_TIMESTAMP(6)
FROM (
...
UNION ALL SELECT 'PAYDUNYA', 'PAYIN', 'BJ', 'MTN', 'HOSTED_CHECKOUT', 'mtn-benin', true, true, true, 20, 0, 0, 0
UNION ALL SELECT 'PAYDUNYA', 'PAYIN', 'BJ', 'MOOV', 'HOSTED_CHECKOUT', 'moov-benin', true, true, true, 20, 0, 0, 0
...
UNION ALL SELECT 'PAYDUNYA', 'PAYIN', 'CI', 'OM', 'HOSTED_CHECKOUT', 'orange-money-ci', true, true, true, 20, 0, 0, 0
UNION ALL SELECT 'PAYDUNYA', 'PAYIN', 'CI', 'MTN', 'HOSTED_CHECKOUT', 'mtn-ci', true, true, true, 20, 0, 0, 0
UNION ALL SELECT 'PAYDUNYA', 'PAYIN', 'CI', 'MOOV', 'HOSTED_CHECKOUT', 'moov-ci', true, true, true, 20, 0, 0, 0
UNION ALL SELECT 'PAYDUNYA', 'PAYIN', 'CI', 'WAVE', 'HOSTED_CHECKOUT', 'wave-ci', true, true, true, 20, 0, 0, 0
...
UNION ALL SELECT 'PAYDUNYA', 'PAYIN', 'SN', 'OM', 'HOSTED_CHECKOUT', 'orange-money-senegal', true, true, true, 20, 0, 0, 0
UNION ALL SELECT 'PAYDUNYA', 'PAYIN', 'SN', 'WAVE', 'HOSTED_CHECKOUT', 'wave-senegal', true, true, true, 20, 0, 0, 0
UNION ALL SELECT 'PAYDUNYA', 'PAYIN', 'SN', 'YAS', 'HOSTED_CHECKOUT', 'free-money-senegal', true, true, true, 20, 0, 0, 0
...
UNION ALL SELECT 'PAYDUNYA', 'PAYIN', 'TG', 'TMONEY', 'HOSTED_CHECKOUT', 't-money-togo', true, true, true, 20, 0, 0, 0
UNION ALL SELECT 'KKIAPAY', 'PAYIN', 'NE', 'AIRTEL', 'MOBILE_MONEY_REQUEST', 'airtel', true, true, true, 10, 0, 0, 0
UNION ALL SELECT 'PAYDUNYA', 'PAYIN', 'BF', 'OM', 'HOSTED_CHECKOUT', 'orange-money-burkina', true, true, true, 20, 0, 0, 0
UNION ALL SELECT 'PAYDUNYA', 'PAYIN', 'BF', 'MOOV', 'HOSTED_CHECKOUT', 'moov-burkina', true, true, true, 20, 0, 0, 0
UNION ALL SELECT 'PAYDUNYA', 'PAYIN', 'CM', 'MTN', 'HOSTED_CHECKOUT', 'mtn-cameroon', true, true, true, 20, 0, 0, 0
UNION ALL SELECT 'PAYDUNYA', 'PAYIN', 'INT', 'VISA', 'HOSTED_CHECKOUT', 'card', true, true, true, 20, 0, 0, 0
UNION ALL SELECT 'PAYDUNYA', 'PAYIN', 'INT', 'MASTERCARD', 'HOSTED_CHECKOUT', 'card', true, true, true, 20, 0, 0, 0
