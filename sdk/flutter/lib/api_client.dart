...
class ApiClient {
  ApiClient({this.basePath = 'http://localhost:8060', this.authentication,});
  ...
  static dynamic fromJson(dynamic value, String targetType, {bool growable = false,}) {
    try {
      switch (targetType) {
        ...
        case 'MerchantPaymentRequest':
          return MerchantPaymentRequest.fromJson(value);
        case 'MerchantPaymentResponse':
          return MerchantPaymentResponse.fromJson(value);
        case 'NextAction':
          return NextAction.fromJson(value);
        case 'OtpActionRequest':
          return OtpActionRequest.fromJson(value);
        default:
          dynamic match;
