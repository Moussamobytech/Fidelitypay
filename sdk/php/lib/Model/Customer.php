...
class Customer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['firstname']) > 120)) {
            $invalidProperties[] = "invalid value for 'firstname', the character length must be smaller than or equal to 120.";
        }
        ...
        if ((mb_strlen($this->container['lastname']) > 120)) {
            $invalidProperties[] = "invalid value for 'lastname', the character length must be smaller than or equal to 120.";
        }
    ...
    public function setFirstname($firstname)
    {
        ...
        if ((mb_strlen($firstname) > 120)) {
            throw new \InvalidArgumentException('invalid length for $firstname when calling Customer., must be smaller than or equal to 120.');
        }
        if ((mb_strlen($firstname) < 0)) {
            throw new \InvalidArgumentException('invalid length for $firstname when calling Customer., must be bigger than or equal to 0.');
        }
    ...
    public function setLastname($lastname)
    {
        ...
        if ((mb_strlen($lastname) > 120)) {
            throw new \InvalidArgumentException('invalid length for $lastname when calling Customer., must be smaller than or equal to 120.');
        }
        if ((mb_strlen($lastname) < 0)) {
            throw new \InvalidArgumentException('invalid length for $lastname when calling Customer., must be bigger than or equal to 0.');
        }
