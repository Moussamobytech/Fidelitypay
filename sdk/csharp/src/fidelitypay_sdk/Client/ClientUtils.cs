...
[assembly: InternalsVisibleTo("fidelitypay_sdk.Test")]
...
namespace fidelitypay_sdk.Client
{
    ...
    public static partial class ClientUtils
    {
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is bool boolean)
                return boolean
                    ? "true"
                    : "false";
            if (obj is MerchantPaymentResponse.StatusEnum merchantPaymentResponseStatusEnum)
                return MerchantPaymentResponse.StatusEnumToJsonValue(merchantPaymentResponseStatusEnum);
            if (obj is MerchantPaymentResponse.ErrorTypeEnum merchantPaymentResponseErrorTypeEnum)
                return MerchantPaymentResponse.ErrorTypeEnumToJsonValue(merchantPaymentResponseErrorTypeEnum);
            if (obj is MerchantPaymentResponse.FailureStageEnum merchantPaymentResponseFailureStageEnum)
                return MerchantPaymentResponse.FailureStageEnumToJsonValue(merchantPaymentResponseFailureStageEnum);
        ...
        /// </summary>
        public const string BASE_ADDRESS = "http://localhost:8060";
