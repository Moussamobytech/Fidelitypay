...
inputSpec: /local/openapi/openapi.json
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{06E24110-FB74-4DF5-A503-E4AC70BC826C}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IMerchantPayInApi>();
            IGetPaymentApiResponse apiResponse = await api.GetPaymentAsync("todo");
            MerchantPaymentResponse? model = apiResponse.Ok();
        }
...
## Api Information
- appName: FidelityPay Merchant SDK API
- appVersion: 1.0.0
- appDescription: Public endpoints for third-party merchant integrations. Authenticate every request with the &#x60;X-API-Key&#x60; header. 
